            ...
            <div className={styles.songSheets}>
                <div className={styles.songSortsSelect}>
                                        ...
                                        <ul className={styles.smallTagsCategory}>
                                            {
                                                item.sub.map((ele, index) => (
                                                    ...
                                                    >
                                                        <div>{ele.name}</div>
                                                        {selectValue === ele.name ? <Icon type='playlistChecked' className={styles.playlistChecked} /> : null}
                    ...
                    <div className={styles.hotTags}>
                        <div>热门标签：</div>
                        <ul>
                            {taglist.map(item => <li key={item.name} onClick={() => this.handleHotTagClick(item.name)}>{item.name}</li>)}
                        </ul>
                    </div>
                </div>
            </div>
